...
class HieBlockFlowgraph(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "HieBlockFlowgraph")
        ...
        # Connections
        ##################################################
        self.connect((self.FrequencyShifter_0, 0), (self.blocks_throttle2_0, 0))
        self.connect((self.analog_noise_source_x_0, 0), (self.low_pass_filter_0, 0))
        self.connect((self.blocks_throttle2_0, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.low_pass_filter_0, 0), (self.FrequencyShifter_0, 0))
    ...
    def set_frequency(self, frequency):
        ...
        self.FrequencyShifter_0.set_frequency(self.frequency)




def main(top_block_cls=HieBlockFlowgraph, options=None):
